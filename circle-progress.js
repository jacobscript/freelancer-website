...
!(function (t) {
                    ...
                    !(function (t) {
                        ...
                        var r = (function () {
                            ...
                            return (
                                ...
                                (x.prototype.setScheduleFunction = function (
                                    t
                                ) {
                        ...
                        (s.prototype.animate = function (t, e, n) {
                            ...
                            ;(this._tweenable = new r()),
                                this._tweenable.tween({
                                    ...
                                    easing: a,
                                    step: function (t) {
                                        ;(l._path.style.strokeDashoffset =
                                            t.offset),
                ...
                function (t, e, n) {
                    ...
                    ;(s.prototype.animate = function (t, e, n) {
                        ...
                        (s.prototype._createSvgView = function (t) {
                            ...
                            return (
                                e.appendChild(r), { svg: e, path: r, trail: n }
                            )
                        }),
                        ...
                        (s.prototype._createTextElement = function (t, e) {
                            ...
                            return (
                                n.appendChild(
                                    document.createTextNode(t.text.value)
                                ),
                                t.text.autoStyle &&
                    ...
                    ;((o.prototype = new r()).constructor = o),
                        ...
                        (o.prototype._trailString = function (t) {
                            ...
                            return i.render(this._trailTemplate, {
                                ...
                                halfOfStrokeWidth: t.strokeWidth / 2,
                                startMargin:
                                    t.strokeWidth / 2 - t.trailWidth / 2,
                            })
                        }),
                        (e.exports = o)
                },
            ...
            if (o.length) {
                ...
                for (
                    n =
                        ...
                        (g = void 0),
                        (_ = void 0),
                        (_ = { height: a.innerHeight, width: a.innerWidth })
                            .height ||
                            (((d = s.compatMode) || !t.support.boxModel) &&
                                (_ = {
                                    height: (g =
                                        'CSS1Compat' === d ? u : s.body)
                                        .clientHeight,
                                    width: g.clientWidth,
                                })),
                        _),
    ...
    $(document).ready(function () {
        var t = document.querySelectorAll('.js-progress')
